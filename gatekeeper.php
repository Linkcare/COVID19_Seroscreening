...
<html>
    ...
    ?>
    		<div class="row">
    			<div class="col-lg-12 col-md-12 text-center" style="padding: 5;">
            		...
            		<p class="mt-4" style="text-transform: uppercase;" >
            			<?php
    ...
    <script type="module">
        ...
        function checkResults(qr) {
            $.get(
    			'actions.php',
                {action: 'check_test_results', qr: qr},
                function(ret){
                    if(ret.result == 0){
                        // No test available
    ...
    <?php
    if ($_GET['prescription']) {
        $prescription = str_replace(chr(10), '', $_GET['prescription']);
        ?>
        checkResults('<?php
        echo $prescription;
        ?>');
